  ...
  return (
    <Layout>
      ...
      <div className="reveal section-spacing grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <section className="surface-panel border border-zinc-200/80 bg-zinc-50/90 p-6 dark:border-zinc-700/80 dark:bg-zinc-900/90">
      ...
      <section className="reveal surface-panel section-spacing border border-zinc-200/80 bg-zinc-50/90 p-6 dark:border-zinc-700/80 dark:bg-zinc-900/90">
        <SectionHeader
          kicker="Subscription"
