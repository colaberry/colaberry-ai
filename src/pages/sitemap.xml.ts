...
const STATIC_ROUTES: Array<{ path: string; changefreq: SitemapUrl["changefreq"]; priority: string }> = [
  ...
  { path: "/aixcelerator/tools", changefreq: "daily", priority: "0.9" },
  { path: "/aixcelerator/ontology", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/ecosystem", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/solution-stacks", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/agents/ontology", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/agents/graph", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/agents/collections", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/mcp/ontology", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/mcp/graph", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/mcp/collections", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/skills/ontology", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/skills/graph", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/skills/collections", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/tools/ontology", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/tools/graph", changefreq: "weekly", priority: "0.5" },
  { path: "/aixcelerator/tools/collections", changefreq: "weekly", priority: "0.5" },
  { path: "/resources/podcasts/ontology", changefreq: "weekly", priority: "0.5" },
  { path: "/resources/podcasts/graph", changefreq: "weekly", priority: "0.5" },
  { path: "/resources/podcasts/collections", changefreq: "weekly", priority: "0.5" },
  { path: "/use-cases", changefreq: "daily", priority: "0.8" },
  { path: "/assistant", changefreq: "weekly", priority: "0.4" },
