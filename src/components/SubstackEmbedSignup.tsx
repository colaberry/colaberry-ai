...
export default function SubstackEmbedSignup({
  ...
  const surfaceChrome = isNarrow
    ? "bg-transparent"
    : "rounded-2xl border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950";
    ...
    >
      ...
      >
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded-full border border-zinc-300 bg-zinc-50 px-4 py-2.5 text-sm text-zinc-900 placeholder:text-zinc-500 transition-colors focus:border-[#DC2626] focus:outline-none focus:ring-2 focus:ring-[#DC2626]/20 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50 dark:placeholder:text-zinc-500 dark:focus:border-[#F87171] dark:focus:ring-[#F87171]/20"
        />
        <button
          type="submit"
