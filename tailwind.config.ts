...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-hero": ["7rem", { lineHeight: "1.02", letterSpacing: "-0.04em" }],
        "display-2xl": ["5.5rem", { lineHeight: "1.04", letterSpacing: "-0.035em" }],
        "display-xl": ["4.5rem", { lineHeight: "1.05", letterSpacing: "-0.03em" }],
        "display-lg": ["3.5rem", { lineHeight: "1.06", letterSpacing: "-0.028em" }],
        "display-md": ["2.625rem", { lineHeight: "1.08", letterSpacing: "-0.022em" }],
        "display-sm": ["2rem", { lineHeight: "1.12", letterSpacing: "-0.018em" }],
